...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f f"**اسف يسطا بس الحساب المساعد محظور او مقيد من الجروب  @{ASSISTANT_USERNAME} بتقدر تتواصل مع مطوري علشان تحل المشكلة @{OWNER_USERNAME}) ✨ **")
    try:
        await USER.get_chat(chid)
    except:
        await lel.edit(
            f"**اسف يسطا بس الحساب المساعد محظور او مقيد من الجروب  @{ASSISTANT_USERNAME} بتقدر تتواصل مع مطوري علشان تحل المشكلة @{OWNER_USERNAME}) ✨ **")
        return
    ...
    if audio:
        ...
        if len(message.command) < 2:
            return await lel.edit(
                "**⌔ رد على ملف صوتي او ارسل اسم اغنيه لتشغيلها...**"
            )
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        await message.reply_photo(
            photo="final.png",
            caption="**⌔ هشغهالك بعد الاغنيه اللي شغاله ...**".format(position),
...
async def pause(_, message: Message):
    ...
    await message.reply_text("**⌔ تم استئناف الاغنيه ...**"
    )
...
async def stop(_, message: Message):
    ...
    await message.reply_text("**⌔ مفيش حاجه شغاله يا اعمى 🤓 ️...**"
    )
...
async def update_admin(client, message):
    ...
    await message.reply_text("**⌔ تم تحديت الملفات ✅️...**")